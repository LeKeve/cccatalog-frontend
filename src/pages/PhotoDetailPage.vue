    ...
    <div class="photo grid-x">
      ...
      <div class="photo_info-ctr cell medium-12 large-4">
        ...
        <ul>
          ...
          <li>
            ...
            <a
              class="photo_license"
              :href="ccLicenseURL"
            >CC {{ image.license }} {{ image.license_version }}</a>
            <license-icons :image="image"></license-icons>
          </li>
          <li>
            <h3>Source</h3>
            <a
              class="photo_provider"
        ...
        <section class="photo_usage">
          ...
          <button class="button photo_copy-btn photo_copy-btn__html" data-type="html">Copy to HTML</button>
          <button class="button photo_copy-btn photo_copy-btn__text" data-type="text">Copy to Text</button>
          <button
    ...
    <div class="photo_tags grid-x full" v-if="tags && tags.length">
      ...
      <div class="photo_tags-ctr cell large-12">
        <template v-for="(tag, index) in image.tags" v-if="tag.name">
          <span
            class="photo_tag button hollow secondary"
            :key="index"
          ...
          >
            ...
            <img
              class="photo_tag-provider-badge"
...
import Vue from 'vue';
import { SELECT_IMAGE_FOR_LIST, SET_IMAGE } from '@/store/mutation-types';
...
const PhotoDetailPage = {
  ...
  computed: {
    ...
    ccLicenseURL() {
      ...
      let url = `${BASE_URL}/licenses/${image.license}/${
    ...
    textAttribution() {
      const image = this.image;
      const licenseURL = `<a href="${this.ccLicenseURL}">
  ...
  methods: {
    ...
    getRelatedImages(tags, query) {
      ...
      if (queryParam) {
        this.$store.dispatch(FETCH_RELATED_IMAGES, {
          q: queryParam,
          pagesize: 8,
        });
      }
